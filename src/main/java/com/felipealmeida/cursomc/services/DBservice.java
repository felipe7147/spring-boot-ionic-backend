...
import com.felipealmeida.cursomc.domain.Cidade;
...
import com.felipealmeida.cursomc.domain.Pagamento;
import com.felipealmeida.cursomc.domain.PagamentoComBoleto;
import com.felipealmeida.cursomc.domain.PagamentoComCartao;
...
import com.felipealmeida.cursomc.domain.enums.Perfil;
import com.felipealmeida.cursomc.domain.enums.TipoCliente;
import com.felipealmeida.cursomc.repositories.CategoriaRepository;
import com.felipealmeida.cursomc.repositories.CidadeRepository;
import com.felipealmeida.cursomc.repositories.ClienteRepository;
import com.felipealmeida.cursomc.repositories.EnderecoRepository;
import com.felipealmeida.cursomc.repositories.EstadoRepository;
import com.felipealmeida.cursomc.repositories.ItemPedidoRepository;
...
import com.felipealmeida.cursomc.repositories.ProdutoRepository;
...
public class DBservice {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p6 = new Produto( null, "Colcha" , 290.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "felipe.nunes7147@gmail.com","36378912377" , TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana costa", "felipe_nunesrodrigues@hotmail.com","41261522028" , TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("86877112", "32347901"));
